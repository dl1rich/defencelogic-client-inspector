...
```js
fetch("https://dl1rich.github.io/defencelogic-client-inspector/defencelogic-client-exposure.js")
  .then(r => r.text())
...
```js
javascript:(()=>{fetch("https://dl1rich.github.io/defencelogic-client-inspector/defencelogic-client-exposure.js").then(r=>r.text()).then(code=>(0,eval)(code))})()
```
